...
const story = `<h3>Once upon a time, ${name} walked into a bar. The bartender nodded politely to  ${name} who took a seat on a barstool. Feeling like they needed to unwind,  ${name} asked the bartender for their favorite drink, a ${typeOfDrink}, in order to quench their ${noun}. 
...
they both proceeded to ${verb} about ${pluralNouns} for the rest of the afternoon.</h3>`;
